...
class WaitersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waiter" do
    assert_difference('Waiter.count') do
      post waiters_url, params: { waiter: { first_name: @waiter.first_name, last_name: @waiter.last_name, pin: @waiter.pin } }
    end
  ...
  test "should update waiter" do
    patch waiter_url(@waiter), params: { waiter: { first_name: @waiter.first_name, last_name: @waiter.last_name, pin: @waiter.pin } }
