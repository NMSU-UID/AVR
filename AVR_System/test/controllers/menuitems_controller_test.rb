...
class MenuitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menuitem" do
    assert_difference('Menuitem.count') do
      post menuitems_url, params: { menuitem: { category_id: @menuitem.category_id, name: @menuitem.name } }
    end
  ...
  test "should update menuitem" do
    patch menuitem_url(@menuitem), params: { menuitem: { category_id: @menuitem.category_id, name: @menuitem.name } }
